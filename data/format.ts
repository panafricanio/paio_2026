  ...
  days: [
    {
      ...
      date: 'July 25',
      duration: '5 hours',
      description: 'Contestants tackle 4 algorithmic problems following the IOI syllabus, testing their knowledge of data structures and algorithms. Problems cover fundamental techniques and mathematical reasoning with increasing difficulty.',
      taskCount: 4,
    },
    {
      id: 'day-2',
      ...
      date: 'July 27',
      duration: '5 hours',
      description: 'Contestants tackle 4 algorithmic problems following the IOI syllabus, testing their knowledge of data structures and algorithms. Problems cover advanced techniques including optimization, graph theory, dynamic programming, etc.',
      taskCount: 4,
    },
  ],
  rules: [
